...
namespace STAFix24_Bcfuture.WysylkaMonituWF
{
    public sealed partial class WysylkaMonituWF : SequentialWorkflowActivity
    {
        ...
        private string _STATUS_ZLECENIA_ANULOWANY = "Anulowane";
        ...
        {
            HistoryDescription = string.Format("CT [{0}] not supported", workflowProperties.Item.ContentType.Name);
            HistoryOutcome = "STOP";
        }
